...
def give_warning():
  ...
  print("ПРЕДУПРЕЖДЕНИЕ: Программа может не работать без прав администратора!")
  print("Лучше запустите её от имени администратора.")
  if input("Введите 1, если наплевать, либо нажмите Enter, чтобы выйти\n>>") != "1":
    exit()
